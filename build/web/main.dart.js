...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var loginScreen = Object.create(dart.library);
  ...
  var T = {
    ...
    BuildContextToLoginPage: () => (T.BuildContextToLoginPage = dart.constFn(dart.fnType(loginScreen.LoginPage, [framework.BuildContext])))(),
    ...
    JSArrayOfRecipe: () => (T.JSArrayOfRecipe = dart.constFn(_interceptors.JSArray$(home.Recipe)))(),
    MapOfString$dynamic: () => (T.MapOfString$dynamic = dart.constFn(core.Map$(core.String, dart.dynamic)))(),
    BuildContextToRecipeDetailScreen: () => (T.BuildContextToRecipeDetailScreen = dart.constFn(dart.fnType(home.RecipeDetailScreen, [framework.BuildContext])))(),
    ...
    MapEntryOfint$StringToText: () => (T.MapEntryOfint$StringToText = dart.constFn(dart.fnType(text.Text, [T.MapEntryOfint$String()])))(),
  ...
  var I = [
    ...
    "file:///zapp/project/lib/splashScreen.dart",
    "file:///zapp/project/lib/loginScreen.dart",
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({title: "Flutter App!!", theme: theme_data.ThemeData.new({colorSchemeSeed: colors.Colors.indigo, useMaterial3: true, brightness: ui.Brightness.light}), darkTheme: theme_data.ThemeData.new({colorSchemeSeed: colors.Colors.blue, useMaterial3: true, brightness: ui.Brightness.dark}), home: new splashScreen.SplashScreen.new()});
    }
  };
  ...
  splashScreen.SplashScreen = class SplashScreen extends framework.StatefulWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new splashScreen.SplashScreen.new({key: key});
    }
    createState() {
  ...
  (splashScreen.SplashScreen.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    splashScreen.SplashScreen.__proto__.new.call(this, {key: key});
    ;
  }).prototype = splashScreen.SplashScreen.prototype;
  dart.addTypeTests(splashScreen.SplashScreen);
  dart.addTypeCaches(splashScreen.SplashScreen);
  ...
  dart.setLibraryUri(splashScreen.SplashScreen, I[1]);
  splashScreen._SplashScreenState = class _SplashScreenState extends framework.State$(splashScreen.SplashScreen) {
    ...
    navigateToHome() {
      return async.async(dart.void, (function* navigateToHome() {
        yield async.Future.delayed(new core.Duration.new({milliseconds: 4000}));
        navigator.Navigator.pushReplacement(dart.dynamic, T.ObjectN(), this.context, new page.MaterialPageRoute.new({builder: dart.fn(context => new loginScreen.LoginPage.new(), T.BuildContextToLoginPage())}));
      }).bind(this));
    }
    build(context) {
      return new scaffold.Scaffold.new({body: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new image.Image.asset("assets/images/receipes-bg.png", {fit: box_fit.BoxFit.fill}), new text.Text.new("Makes your cooking easy", {style: new text_style.TextStyle.new({color: colors.Colors.brown, fontSize: 20, fontWeight: ui.FontWeight.bold, decoration: ui.TextDecoration.underline, fontFamily: "Raleway"})})])})});
    }
  ...
  dart.addTypeCaches(splashScreen._SplashScreenState);
  dart.setMethodSignature(splashScreen._SplashScreenState, () => ({
    ...
    navigateToHome: dart.fnType(dart.void, []),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(splashScreen._SplashScreenState, I[1]);
  splashScreen.Home = class Home extends framework.StatelessWidget {
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Home")}), body: new basic.Center.new({child: new text.Text.new("Home Screen", {style: new text_style.TextStyle.new({fontSize: 20})})})});
    }
    static ['_#new#tearOff']() {
      return new splashScreen.Home.new();
    }
  };
  (splashScreen.Home.new = function() {
    splashScreen.Home.__proto__.new.call(this);
    ;
  }).prototype = splashScreen.Home.prototype;
  dart.addTypeTests(splashScreen.Home);
  dart.addTypeCaches(splashScreen.Home);
  dart.setMethodSignature(splashScreen.Home, () => ({
    __proto__: dart.getMethods(splashScreen.Home.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(splashScreen.Home, I[1]);
  loginScreen.LoginPage = class LoginPage extends framework.StatelessWidget {
    build(context) {
      return new scaffold.Scaffold.new({body: new loginScreen.LoginForm.new()});
    }
    static ['_#new#tearOff']() {
      return new loginScreen.LoginPage.new();
    }
  };
  (loginScreen.LoginPage.new = function() {
    loginScreen.LoginPage.__proto__.new.call(this);
    ;
  }).prototype = loginScreen.LoginPage.prototype;
  dart.addTypeTests(loginScreen.LoginPage);
  dart.addTypeCaches(loginScreen.LoginPage);
  dart.setMethodSignature(loginScreen.LoginPage, () => ({
    __proto__: dart.getMethods(loginScreen.LoginPage.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(loginScreen.LoginPage, I[2]);
  loginScreen.LoginForm = class LoginForm extends framework.StatefulWidget {
    createState() {
      return new loginScreen._LoginFormState.new();
    }
    static ['_#new#tearOff']() {
      return new loginScreen.LoginForm.new();
    }
  };
  (loginScreen.LoginForm.new = function() {
    loginScreen.LoginForm.__proto__.new.call(this);
    ;
  }).prototype = loginScreen.LoginForm.prototype;
  dart.addTypeTests(loginScreen.LoginForm);
  dart.addTypeCaches(loginScreen.LoginForm);
  dart.setMethodSignature(loginScreen.LoginForm, () => ({
    __proto__: dart.getMethods(loginScreen.LoginForm.__proto__),
    createState: dart.fnType(loginScreen._LoginFormState, [])
  }));
  dart.setLibraryUri(loginScreen.LoginForm, I[2]);
  var _usernameController = dart.privateName(loginScreen, "_usernameController");
  var _passwordController = dart.privateName(loginScreen, "_passwordController");
  var _login = dart.privateName(loginScreen, "_login");
  loginScreen._LoginFormState = class _LoginFormState extends framework.State$(loginScreen.LoginForm) {
    [_login]() {
      navigator.Navigator.pushReplacement(dart.dynamic, T.ObjectN(), this.context, new page.MaterialPageRoute.new({builder: dart.fn(context => new home.HomeScreen.new(), T.BuildContextToHomeScreen())}));
    }
    build(context) {
      return new basic.Padding.new({padding: new edge_insets.EdgeInsets.all(16), child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new text.Text.new("login", {style: new text_style.TextStyle.new({color: colors.Colors.brown, fontSize: 20, fontWeight: ui.FontWeight.bold, fontFamily: "Raleway"})}), new text_field.TextField.new({controller: this[_usernameController], decoration: new input_decorator.InputDecoration.new({labelText: "Username"})}), new basic.SizedBox.new({height: 16}), new text_field.TextField.new({controller: this[_passwordController], decoration: new input_decorator.InputDecoration.new({labelText: "Password", suffixIcon: new icon.Icon.new(icons.Icons.remove_red_eye)}), obscureText: true}), new basic.SizedBox.new({height: 16}), new elevated_button.ElevatedButton.new({onPressed: dart.bind(this, _login), child: new text.Text.new("Please Login")})])})});
    }
    static ['_#new#tearOff']() {
      return new loginScreen._LoginFormState.new();
    }
  };
  (loginScreen._LoginFormState.new = function() {
    ...
    loginScreen._LoginFormState.__proto__.new.call(this);
    ;
  }).prototype = loginScreen._LoginFormState.prototype;
  dart.addTypeTests(loginScreen._LoginFormState);
  dart.addTypeCaches(loginScreen._LoginFormState);
  dart.setMethodSignature(loginScreen._LoginFormState, () => ({
    __proto__: dart.getMethods(loginScreen._LoginFormState.__proto__),
    [_login]: dart.fnType(dart.void, []),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(loginScreen._LoginFormState, I[2]);
  dart.setFieldSignature(loginScreen._LoginFormState, () => ({
    __proto__: dart.getFields(loginScreen._LoginFormState.__proto__),
  ...
  var title$ = dart.privateName(home, "Recipe.title");
  var subtitle$ = dart.privateName(home, "Recipe.subtitle");
  var imageUrl$ = dart.privateName(home, "Recipe.imageUrl");
  var data$ = dart.privateName(home, "Recipe.data");
  home.Recipe = class Recipe extends core.Object {
    get title() {
      return this[title$];
    }
    set title(value) {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new home.Recipe.new({title: title, subtitle: subtitle, imageUrl: imageUrl, data: data});
    }
    static fromJson(json) {
      return new home.Recipe.new({title: core.String.as(json[$_get]("name")), subtitle: core.String.as(json[$_get]("cuisine")), imageUrl: core.String.as(json[$_get]("image")), data: json});
    }
    static ['_#fromJson#tearOff'](json) {
      return home.Recipe.fromJson(json);
    }
  };
  (home.Recipe.new = function(opts) {
    let title = opts && 'title' in opts ? opts.title : null;
    let subtitle = opts && 'subtitle' in opts ? opts.subtitle : null;
    let imageUrl = opts && 'imageUrl' in opts ? opts.imageUrl : null;
    let data = opts && 'data' in opts ? opts.data : null;
    ...
    this[data$] = data;
    ;
  }).prototype = home.Recipe.prototype;
  dart.addTypeTests(home.Recipe);
  dart.addTypeCaches(home.Recipe);
  dart.setStaticMethodSignature(home.Recipe, () => ['fromJson']);
  dart.setLibraryUri(home.Recipe, I[3]);
  dart.setFieldSignature(home.Recipe, () => ({
    __proto__: dart.getFields(home.Recipe.__proto__),
  ...
  var ___HomeScreenState_recipes = dart.privateName(home, "_#_HomeScreenState#recipes");
  home._HomeScreenState = class _HomeScreenState extends framework.State$(home.HomeScreen) {
    get recipes() {
      let t0;
      t0 = this[___HomeScreenState_recipes];
      return t0 == null ? this[___HomeScreenState_recipes] = T.JSArrayOfRecipe().of([]) : t0;
    }
    set recipes(recipes$35param) {
      this[___HomeScreenState_recipes] = recipes$35param;
    }
    initState() {
      super.initState();
      this.fetchRecipes();
    ...
    fetchRecipes() {
      return async.async(dart.void, (function* fetchRecipes() {
        let response = (yield http.get(core.Uri.parse("https://dummyjson.com/recipes")));
        if (response.statusCode === 200) {
          let result = core.List.as(dart.dsend(convert.json.decode(response.body), '_get', ["recipes"]));
          let recipeList = T.JSArrayOfRecipe().of([]);
          for (let recipeJson of result) {
            recipeList[$add](home.Recipe.fromJson(T.MapOfString$dynamic().as(recipeJson)));
          }
          this.setState(dart.fn(() => {
            this.recipes = recipeList;
          }, T.VoidTovoid()));
        } else {
          dart.throw(core.Exception.new("Failed to load recipes"));
        }
      }).bind(this));
    }
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Welcome to the recipe world")}), body: this.recipes !== null ? new scroll_view.ListView.builder({itemCount: this.recipes[$length], itemBuilder: dart.fn((context, index) => {
            let recipe = this.recipes[$_get](index);
            return new gesture_detector.GestureDetector.new({onTap: dart.fn(() => {
                navigator.Navigator.push(dart.dynamic, context, new page.MaterialPageRoute.new({builder: dart.fn(context => new home.RecipeDetailScreen.new({title: recipe.title, subtitle: recipe.subtitle, imageUrl: recipe.imageUrl, data: recipe.data}), T.BuildContextToRecipeDetailScreen())}));
              }, T.VoidTovoid()), child: new container.Container.new({margin: new edge_insets.EdgeInsets.symmetric({vertical: 8, horizontal: 16}), child: new card.Card.new({clipBehavior: ui.Clip.antiAliasWithSaveLayer, child: new basic.Column.new({crossAxisAlignment: flex.CrossAxisAlignment.start, children: T.JSArrayOfWidget().of([new basic.SizedBox.new({width: 1 / 0, height: 200, child: new image.Image.network(recipe.imageUrl, {fit: box_fit.BoxFit.cover})}), new basic.Padding.new({padding: new edge_insets.EdgeInsets.all(16), child: new basic.Column.new({crossAxisAlignment: flex.CrossAxisAlignment.start, children: T.JSArrayOfWidget().of([new text.Text.new(recipe.title, {style: new text_style.TextStyle.new({fontSize: 20, fontWeight: ui.FontWeight.bold})}), new basic.SizedBox.new({height: 8}), new text.Text.new(recipe.subtitle, {style: new text_style.TextStyle.new({fontSize: 16})})])})})])})})})});
          }, T.BuildContextAndintToGestureDetector())}) : new basic.Center.new({child: new progress_indicator.CircularProgressIndicator.new()})});
    }
    static ['_#new#tearOff']() {
      return new home._HomeScreenState.new();
    }
  ...
  (home._HomeScreenState.new = function() {
    this[___HomeScreenState_recipes] = null;
  ...
  dart.setFieldSignature(home._HomeScreenState, () => ({
    ...
    [___HomeScreenState_recipes]: dart.fieldType(dart.nullable(core.List$(home.Recipe)))
  }));
  var title$0 = dart.privateName(home, "RecipeDetailScreen.title");
  var subtitle$0 = dart.privateName(home, "RecipeDetailScreen.subtitle");
  var imageUrl$0 = dart.privateName(home, "RecipeDetailScreen.imageUrl");
  var data$0 = dart.privateName(home, "RecipeDetailScreen.data");
  home.RecipeDetailScreen = class RecipeDetailScreen extends framework.StatelessWidget {
    get title() {
      return this[title$0];
    }
    set title(value) {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      let imageUrl = opts && 'imageUrl' in opts ? opts.imageUrl : null;
      let data = opts && 'data' in opts ? opts.data : null;
      return new home.RecipeDetailScreen.new({title: title, subtitle: subtitle, imageUrl: imageUrl, data: data});
    }
    build(context) {
      let ingredients = T.ListOfString().from(core.Iterable.as(dart.dsend(this.data, '_get', ["ingredients"])));
      let instructions = T.ListOfString().from(core.Iterable.as(dart.dsend(this.data, '_get', ["instructions"])));
      let prepTimeMinutes = core.int.as(dart.dsend(this.data, '_get', ["prepTimeMinutes"]));
      let cookTimeMinutes = core.int.as(dart.dsend(this.data, '_get', ["cookTimeMinutes"]));
      let servings = core.int.as(dart.dsend(this.data, '_get', ["servings"]));
      let difficulty = core.String.as(dart.dsend(this.data, '_get', ["difficulty"]));
      let cuisine = core.String.as(dart.dsend(this.data, '_get', ["cuisine"]));
      let caloriesPerServing = core.double.as(dart.dsend(dart.dsend(this.data, '_get', ["caloriesPerServing"]), 'toDouble', []));
      let tags = T.ListOfString().from(core.Iterable.as(dart.dsend(this.data, '_get', ["tags"])));
      let rating = core.double.as(dart.dsend(this.data, '_get', ["rating"]));
      let reviewCount = core.int.as(dart.dsend(this.data, '_get', ["reviewCount"]));
      let mealType = T.ListOfString().from(core.Iterable.as(dart.dsend(this.data, '_get', ["mealType"])));
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Recipe Detail")}), body: new single_child_scroll_view.SingleChildScrollView.new({child: new basic.Column.new({crossAxisAlignment: flex.CrossAxisAlignment.start, children: T.JSArrayOfWidget().of([new image.Image.network(this.imageUrl, {fit: box_fit.BoxFit.cover, width: 1 / 0, height: 200}), new basic.Padding.new({padding: new edge_insets.EdgeInsets.all(16), child: new basic.Column.new({crossAxisAlignment: flex.CrossAxisAlignment.start, children: T.JSArrayOfWidget().of([new text.Text.new(this.title, {style: new text_style.TextStyle.new({fontSize: 24, fontWeight: ui.FontWeight.bold})}), new basic.SizedBox.new({height: 8}), new text.Text.new(this.subtitle, {style: new text_style.TextStyle.new({fontSize: 18})}), new basic.SizedBox.new({height: 16}), new text.Text.new("Ingredients:", {style: new text_style.TextStyle.new({fontSize: 20, fontWeight: ui.FontWeight.bold})}), new basic.Column.new({crossAxisAlignment: flex.CrossAxisAlignment.start, children: ingredients[$map](text.Text, dart.fn(ingredient => new text.Text.new("- " + ingredient), T.StringToText()))[$toList]()}), new basic.SizedBox.new({height: 16}), new text.Text.new("Instructions:", {style: new text_style.TextStyle.new({fontSize: 20, fontWeight: ui.FontWeight.bold})}), new basic.Column.new({crossAxisAlignment: flex.CrossAxisAlignment.start, children: instructions[$asMap]()[$entries][$map](text.Text, dart.fn(entry => new text.Text.new(dart.str(entry.key + 1) + ". " + entry.value), T.MapEntryOfint$StringToText()))[$toList]()}), new basic.SizedBox.new({height: 16}), new text.Text.new("Prep Time: " + dart.str(prepTimeMinutes) + " minutes", {style: new text_style.TextStyle.new({fontSize: 18})}), new text.Text.new("Cook Time: " + dart.str(cookTimeMinutes) + " minutes", {style: new text_style.TextStyle.new({fontSize: 18})}), new text.Text.new("Servings: " + dart.str(servings), {style: new text_style.TextStyle.new({fontSize: 18})}), new text.Text.new("Difficulty: " + difficulty, {style: new text_style.TextStyle.new({fontSize: 18})}), new text.Text.new("Cuisine: " + cuisine, {style: new text_style.TextStyle.new({fontSize: 18})}), new text.Text.new("Calories Per Serving: " + dart.str(caloriesPerServing), {style: new text_style.TextStyle.new({fontSize: 18})}), new text.Text.new("Rating: " + dart.str(rating), {style: new text_style.TextStyle.new({fontSize: 18})}), new text.Text.new("Review Count: " + dart.str(reviewCount), {style: new text_style.TextStyle.new({fontSize: 18})}), new text.Text.new("Meal Type: " + mealType[$join](", "), {style: new text_style.TextStyle.new({fontSize: 18})}), new basic.SizedBox.new({height: 16}), new text.Text.new("Tags: " + tags[$join](", "), {style: new text_style.TextStyle.new({fontSize: 18})})])})})])})})});
    }
  };
  (home.RecipeDetailScreen.new = function(opts) {
    let title = opts && 'title' in opts ? opts.title : null;
    let subtitle = opts && 'subtitle' in opts ? opts.subtitle : null;
    let imageUrl = opts && 'imageUrl' in opts ? opts.imageUrl : null;
    let data = opts && 'data' in opts ? opts.data : null;
    ...
    this[data$0] = data;
    home.RecipeDetailScreen.__proto__.new.call(this);
    ;
  }).prototype = home.RecipeDetailScreen.prototype;
  dart.addTypeTests(home.RecipeDetailScreen);
  dart.addTypeCaches(home.RecipeDetailScreen);
  dart.setMethodSignature(home.RecipeDetailScreen, () => ({
    __proto__: dart.getMethods(home.RecipeDetailScreen.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(home.RecipeDetailScreen, I[3]);
  dart.setFieldSignature(home.RecipeDetailScreen, () => ({
    __proto__: dart.getFields(home.RecipeDetailScreen.__proto__),
    title: dart.finalFieldType(core.String),
    subtitle: dart.finalFieldType(core.String),
    imageUrl: dart.finalFieldType(core.String),
    data: dart.finalFieldType(dart.dynamic)
  ...
  typed_queue._nextPowerOf2 = function _nextPowerOf2(number) {
    if (!(number > 0)) dart.assertFailed(null, I[23], 691, 10, "number > 0");
    number = (number << 1 >>> 0) - 1;
    for (;;) {
  ...
  dart.trackLibraries("zapp_user_main", {
    ...
    "file:///zapp/project/lib/splashScreen.dart": splashScreen,
    "file:///zapp/project/lib/loginScreen.dart": loginScreen,
